...
{
	// ･､･ｹ･ｿ･ｹ･ｲ･ﾃ･ｿ
	NCB_INSTANCE_GETTER(objthis) { // objthis ､・iTJSDispatch2* ﾐﾍ､ﾎﾒﾊ､ﾈ､ｹ､・
		ClassT* obj = GetNativeInstance(objthis);	// ･ﾍ･､･ﾆ･｣･ﾖ･､･ｹ･ｿ･ｹ･ﾝ･､･ｿﾈ｡ｵﾃ
		if (!obj) {
			obj = new ClassT(objthis);				// ､ﾊ､､因ｺﾏ､ﾏﾉ嵭ﾉ､ｹ､・
			SetNativeInstance(objthis, obj);		// objthis ､ﾋ obj ､ﾍ･､･ﾆ･｣･ﾖ･､･ｹ･ｿ･ｹ､ﾈ､ｷ､ﾆｵﾇ乕､ｹ､・
		}
		obj->reset();
		return obj;
	}
