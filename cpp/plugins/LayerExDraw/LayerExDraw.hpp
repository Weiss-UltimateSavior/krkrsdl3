...
public:
     ...
     * @param oy 表示オフセットY
     */
    void addPen(tTJSVariant colorOrBrush,
...
public:
    ...
    void startFigure();
    void closeFigure();
    void drawArc(tjs_real x,
                 tjs_real y,
                 tjs_real width,
                 tjs_real height,
                 tjs_real startAngle,
                 tjs_real sweepAngle);
    void drawBezier(tjs_real x1,
                    tjs_real y1,
                    tjs_real x2,
                    tjs_real y2,
                    tjs_real x3,
...
public:
     ...
     * @return 更新領域情報
     */
    RectF drawArc(const Appearance* app,
                  tjs_real x,
                  tjs_real y,
                  tjs_real width,
                  tjs_real height,
     ...
     * @return 更新領域情報
     */
    RectF drawPie(const Appearance* app,
                  tjs_real x,
                  tjs_real y,
                  tjs_real width,
                  tjs_real height,
     ...
     * @return 更新領域情報
     */
    RectF drawBezier(const Appearance* app,
                     tjs_real x1,
                     tjs_real y1,
                     tjs_real x2,
                     tjs_real y2,
     ...
     * @return 更新領域情報
     */
    RectF drawCurve3(const Appearance* app,
                     tTJSVariant points,
                     int offset,
     ...
     * @return 更新領域情報
     */
    RectF drawImageRect(tjs_real dleft,
                        tjs_real dtop,
                        GdipImage* src,
                        tjs_real sleft,
                        tjs_real stop,
     ...
     * @return 更新領域情報
     */
    RectF drawImageStretch(tjs_real dleft,
                           tjs_real dtop,
                           tjs_real dwidth,
                           tjs_real dheight,
                           GdipImage* src,
     ...
     * @return 更新領域情報
     */
    RectF drawImageAffine(GdipImage* src,
                          tjs_real sleft,
                          tjs_real stop,
                          tjs_real swidth,
                          tjs_real sheight,
