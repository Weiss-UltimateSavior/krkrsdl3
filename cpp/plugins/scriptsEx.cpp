...
int bitap_fuzzy_bitwise_search(const CHAR* text,
                               ...
                               size_t k,
                               size_t maskbits = sizeof(MASK))
{
    typedef std::numeric_limits<MASK> MaskLimit;
    static_assert(MaskLimit::is_integer && !MaskLimit::is_signed && (MaskLimit::radix == 2),
                  "MASK must be unsigned integer type");

    if (!text || !text_len || !pattern)
        return -3; // invalid args
    if (!pattern_len)
        return 0; // no search pattern (= found first)
    else if (pattern_len >= sizeof(MASK) * MaskLimit::digits)
        return -2; // too long pattern
...
static bool _CatchFuncCall(void* data, const tTVPExceptionDesc& desc)
{
    throw desc;
}
...
struct t_iTJSDispatch2_PropGet
{
    ...
    t_iTJSDispatch2_PropGet(iTJSDispatch2* _this_,
                            tjs_uint32 flag_,
...
static void _Try_iTJSDispatch2_PropGet(void* data)
{
    t_iTJSDispatch2_PropGet* arg = (t_iTJSDispatch2_PropGet*)data;
    arg->_ret =
        arg->_this->PropGet(arg->flag, arg->membername, arg->hint, arg->result, arg->objthis);
}
tjs_error Try_iTJSDispatch2_PropGet(iTJSDispatch2* _this,
                                    tjs_uint32 flag,
                                    const tjs_char* membername,
                                    tjs_uint32* hint,
                                    tTJSVariant* result,
...
static void _Try_iTJSDispatch2_AddRef(void* data)
{
...
struct t_iTJSDispatch2_PropGetByNum
{
    ...
    t_iTJSDispatch2_PropGetByNum(iTJSDispatch2* _this_,
                                 tjs_uint32 flag_,
                                 tjs_int num_,
                                 tTJSVariant* result_,
                                 iTJSDispatch2* objthis_)
...
static void _Try_iTJSDispatch2_PropGetByNum(void* data)
{
...
struct t_iTJSDispatch2_PropSet
{
    ...
    t_iTJSDispatch2_PropSet(iTJSDispatch2* _this_,
                            tjs_uint32 flag_,
                            const tjs_char* membername_,
                            tjs_uint32* hint_,
...
tjs_error Try_iTJSDispatch2_PropGetByNum(
    iTJSDispatch2* _this, tjs_uint32 flag, tjs_int num, tTJSVariant* result, iTJSDispatch2* objthis)
{
...
static void _Try_iTJSDispatch2_PropSet(void* data)
{
    t_iTJSDispatch2_PropSet* arg = (t_iTJSDispatch2_PropSet*)data;
    arg->_ret =
        arg->_this->PropSet(arg->flag, arg->membername, arg->hint, arg->param, arg->objthis);
}
tjs_error Try_iTJSDispatch2_PropSet(iTJSDispatch2* _this,
                                    tjs_uint32 flag,
                                    const tjs_char* membername,
                                    tjs_uint32* hint,
                                    const tTJSVariant* param,
...
struct t_iTJSDispatch2_PropSetByNum
{
    ...
    t_iTJSDispatch2_PropSetByNum(iTJSDispatch2* _this_,
                                 tjs_uint32 flag_,
                                 tjs_int num_,
                                 const tTJSVariant* param_,
                                 iTJSDispatch2* objthis_)
...
static void _Try_iTJSDispatch2_PropSetByNum(void* data)
{
...
tjs_error Try_iTJSDispatch2_PropSetByNum(iTJSDispatch2* _this,
                                         tjs_uint32 flag,
                                         tjs_int num,
                                         const tTJSVariant* param,
                                         iTJSDispatch2* objthis)
    ...
    )
    {
        ...
        if (numparams > 1)
        {
            if ((int)*param[1] != TJS_HIDDENMEMBER)
            {
                ...
                if (target.PropGet(TJS_MEMBERMUSTEXIST, key, NULL, &targetValue, NULL) == TJS_S_OK)
                {
                                              ...
                                              iTJSDispatch2* objthis)
{
    ...
    return ((param[1]->Type() != tvtInteger)
                ? Try_iTJSDispatch2_PropSet(clo.Object, flag, param[1]->GetString(),
                                            param[1]->GetHint(), param[2], clo.ObjThis)
                : Try_iTJSDispatch2_PropSetByNum(clo.Object, flag, param[1]->operator tjs_int(),
                                                 param[2], clo.ObjThis));
}
                                              ...
                                              iTJSDispatch2* objthis)
{
    ...
    tjs_uint32 flag =
        (numparams > 2) ? (tjs_uint32)param[2]->operator tjs_int() : TJS_MEMBERMUSTEXIST;
    return ((param[1]->Type() != tvtInteger)
                ? Try_iTJSDispatch2_PropGet(clo.Object, flag, param[1]->GetString(),
                                            param[1]->GetHint(), result, clo.ObjThis)
                : Try_iTJSDispatch2_PropGetByNum(clo.Object, flag, param[1]->operator tjs_int(),
                                                 result, clo.ObjThis));
}
