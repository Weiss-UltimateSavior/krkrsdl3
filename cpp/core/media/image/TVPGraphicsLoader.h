...
extern void TVPRegisterGraphicLoadingHandler(const ttstr& name, tTVPGraphicLoadingHandlerForPlugin loading, tTVPGraphicHeaderLoadingHandlerForPlugin header, tTVPGraphicSaveHandlerForPlugin save, tTVPGraphicAcceptSaveHandler accept, void* formatdata);

extern void TVPUnregisterGraphicLoadingHandler(const ttstr& name, tTVPGraphicLoadingHandlerForPlugin loading, tTVPGraphicHeaderLoadingHandlerForPlugin header, tTVPGraphicSaveHandlerForPlugin save, tTVPGraphicAcceptSaveHandler accept, void* formatdata);
//---------------------------------------------------------------------------
...
void TVPSaveTextureAsBMP(tTJSBinaryStream* dst, class iTVPTexture2D* bmp, const ttstr & mode = TJS_N(""), iTJSDispatch2* meta = nullptr);
void TVPSaveTextureAsBMP(const ttstr &path, class iTVPTexture2D* tex, const ttstr &mode = TJS_N(""), iTJSDispatch2* meta = nullptr);
