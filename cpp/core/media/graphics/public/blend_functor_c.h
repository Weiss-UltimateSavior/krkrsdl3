 ...
 * alpha_blend_ao_functor;		// dstアルファ有効, opacity 指定, addalpha(pre-multiplied
 * alpha)
 */
//------------------------------------------------------------------------------
/** アルファブレンド */
...
struct premulalpha_blend_HDA_o_functor
{
    ...
    inline tjs_uint32 operator()(tjs_uint32 d, tjs_uint32 s) const
    {
        ...
        tjs_uint32 a =
            (((d & 0xff00ff) * sopa >> 8) & 0xff00ff) + (((d & 0xff00) * sopa >> 8) & 0xff00);
        tjs_uint32 b = s;
...
struct add_blend_functor
{ // == saturated_u8_add_func
...
struct const_alpha_fill_blend_d_functor
{
    ...
    inline const_alpha_fill_blend_d_functor(tjs_int32 opa, tjs_int32 color)
      : opa_(opa),
        color_(color & 0xff00ff),
        color_mid_(color & 0xff00)
    {
    }
    inline tjs_uint32 operator()(tjs_uint32 d) const
    {
...
struct const_alpha_fill_blend_a_functor
{
    ...
    inline const_alpha_fill_blend_a_functor(tjs_int32 opa, tjs_int32 color)
      : opa_(opa),
        color_((((((color & 0x00ff00) * opa) & 0x00ff0000) +
...
struct convet_premulalpha_to_alpha_functor
{
    inline tjs_uint32 operator()(tjs_uint32 d) const
    {
        ...
        return (tmp & 0xff000000) + (t[(tmp >> 16) & 0xff] << 16) + (t[(tmp >> 8) & 0xff] << 8) +
               (t[tmp & 0xff]);
    }
};
struct convet_alpha_to_premulalpha_functor
{
    inline tjs_uint32 operator()(tjs_uint32 d) const
    {
        ...
        tjs_uint32 color =
            (((((d & 0x00ff00) * alpha) & 0x00ff0000) + (((d & 0xff00ff) * alpha) & 0xff00ff00)) >>
             8);
