...
public:
    ...
    virtual void NotifyMouseDown(tjs_int x, tjs_int y, tTVPMouseButton mb, tjs_uint32 flags) = 0;
           ...
           //! @param		mb		どのマウスボタンか
           //! @param		flags	フラグ(TVP_SS_*定数の組み合わせ)
    virtual void NotifyMouseUp(tjs_int x, tjs_int y, tTVPMouseButton mb, tjs_uint32 flags) = 0;
    ...
    virtual void NotifyKeyPress(tjs_char key) = 0;
           ...
           //! @param		x		プライマリレイヤ座標上における x 位置
           //! @param		y		プライマリレイヤ座標上における y 位置
    virtual void NotifyMouseWheel(tjs_uint32 shift, tjs_int delta, tjs_int x, tjs_int y) = 0;
           ...
           //! @param		cy		触れている高さ
           //! @param		id		タッチ識別用ID
    virtual void NotifyTouchDown( tjs_real x, tjs_real y, tjs_real cx, tjs_real cy, tjs_uint32 id ) = 0;
           ...
           //! @param		cy		触れている高さ
           //! @param		id		タッチ識別用ID
    virtual void NotifyTouchUp( tjs_real x, tjs_real y, tjs_real cx, tjs_real cy, tjs_uint32 id ) = 0;
           ...
           //! @param		cy		触れている高さ
           //! @param		id		タッチ識別用ID
    virtual void NotifyTouchMove( tjs_real x, tjs_real y, tjs_real cx, tjs_real cy, tjs_uint32 id ) = 0;
           ...
           //! @param		cy		触れている高さ
           //! @param		flag	タッチ状態フラグ
    virtual void NotifyTouchScaling( tjs_real startdist, tjs_real curdist, tjs_real cx, tjs_real cy, tjs_int flag ) = 0;
           ...
           //! @param		cy		触れている高さ
           //! @param		flag	タッチ状態フラグ
    virtual void NotifyTouchRotate( tjs_real startangle, tjs_real curangle, tjs_real dist, tjs_real cx, tjs_real cy, tjs_int flag ) = 0;
...
public:
    ...
    virtual void SetDrawDeviceData(void * data) override { DrawDeviceData = data; }
    virtual void * GetDrawDeviceData() const  override{ return DrawDeviceData; }
...
public:
    virtual void SetDesiredLayerType(tTVPLayerType type) override { DesiredLayerType = type; }
...
public: // methods from tTVPDrawable
    ...
    virtual tTVPBaseTexture *GetDrawBuffer()  override{ return DrawBuffer; }
...
public:
    ...
    virtual tTJSNI_BaseLayer * GetPrimaryLayer() const  override{ return Primary; }
    bool IsPrimaryLayerAttached() const { return Primary != NULL; }

    virtual bool GetPrimaryLayerSize(tjs_int &w, tjs_int &h) const override;
...
public:
    ...
    virtual void RequestInvalidation(const tTVPRect &r) override; // draw device -> layer

    virtual void NotifyClick(tjs_int x, tjs_int y) override { PrimaryClick(x, y); }
    virtual void NotifyDoubleClick(tjs_int x, tjs_int y) override { PrimaryDoubleClick(x, y); }
    virtual void NotifyMouseDown(tjs_int x, tjs_int y, tTVPMouseButton mb, tjs_uint32 flags) override
    { PrimaryMouseDown(x, y, mb, flags); }
    virtual void NotifyMouseUp(tjs_int x, tjs_int y, tTVPMouseButton mb, tjs_uint32 flags) override
    { PrimaryMouseUp(x, y, mb, flags); }
    virtual void NotifyMouseMove(tjs_int x, tjs_int y, tjs_uint32 flags) override
    { PrimaryMouseMove(x, y, flags); }
    virtual void NotifyMouseOutOfWindow() override
    { MouseOutOfWindow(); }
    virtual void NotifyKeyDown(tjs_uint key, tjs_uint32 shift) override
    { PrimaryKeyDown(key, shift); }
    virtual void NotifyKeyUp(tjs_uint key, tjs_uint32 shift) override
    { PrimaryKeyUp(key, shift); }
    virtual void NotifyKeyPress(tjs_char key) override
    { PrimaryKeyPress(key); }
    ...
    virtual void NotifyTouchDown( tjs_real x, tjs_real y, tjs_real cx, tjs_real cy, tjs_uint32 id ) override
    { PrimaryTouchDown(x, y, cx, cy, id); }
    virtual void NotifyTouchUp( tjs_real x, tjs_real y, tjs_real cx, tjs_real cy, tjs_uint32 id ) override
    { PrimaryTouchUp(x, y, cx, cy, id); }
    virtual void NotifyTouchMove( tjs_real x, tjs_real y, tjs_real cx, tjs_real cy, tjs_uint32 id ) override
    { PrimaryTouchMove(x, y, cx, cy, id); }
    virtual void NotifyTouchScaling( tjs_real startdist, tjs_real curdist, tjs_real cx, tjs_real cy, tjs_int flag ) override
    { PrimaryTouchScaling(startdist, curdist, cx, cy, flag); }
    virtual void NotifyTouchRotate( tjs_real startangle, tjs_real curangle, tjs_real dist, tjs_real cx, tjs_real cy, tjs_int flag ) override
    { PrimaryTouchRotate(startangle, curangle, dist, cx, cy, flag); }
    virtual void NotifyMultiTouch() override
    { PrimaryMultiTouch(); }
    ...
    virtual tTJSNI_BaseLayer * GetFocusedLayer() const override { return FocusedLayer; }
...
public:
    ...
    virtual void UpdateToDrawDevice() override;
