...
/*]*/
//---------------------------------------------------------------------------
extern void TVPPostEvent(iTJSDispatch2 *source, iTJSDispatch2 *target,
...
extern tjs_int TVPCancelEvents(iTJSDispatch2 *source, iTJSDispatch2 *target,
...
extern bool TVPAreEventsInQueue(iTJSDispatch2 *source, iTJSDispatch2 *target,
...
extern void TVPCancelEventsByTag(iTJSDispatch2 *source, iTJSDispatch2 *target,
                                 tjs_uint32 tag = 0);
