...
namespace TJS
{
extern void TJSThrowNullAccess();
extern void TJSThrowDivideByZero();
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
extern tTJSVariantOctet* TJSAllocVariantOctet(const tjs_uint8* data, tjs_uint length);
extern tTJSVariantOctet* TJSAllocVariantOctet(const tjs_uint8* data1,
                                              tjs_uint len1,
                                              const tjs_uint8* data2,
                                              tjs_uint len2);
extern tTJSVariantOctet* TJSAllocVariantOctet(const tTJSVariantOctet* o1,
                                              const tTJSVariantOctet* o2);
extern tTJSVariantOctet* TJSAllocVariantOctet(const tjs_uint8** src);
extern void TJSDeallocVariantOctet(tTJSVariantOctet* o);
...
/*]*/
//---------------------------------------------------------------------------
extern tTJSVariantString* TJSObjectToString(const tTJSVariantClosure& dsp);
extern tTJSVariantString* TJSIntegerToString(tjs_int64 i);
extern tTJSVariantString* TJSRealToString(tjs_real r);
extern tTJSVariantString* TJSRealToHexString(tjs_real r);
